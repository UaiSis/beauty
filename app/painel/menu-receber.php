...
<div class="content">
	<div class="d-flex">
		<div>
			<h1 class="mb-0 font-20">Contas a Receber</h1>
		</div>
	...
	?>
		...
		<div class="d-flex">
			<div class="align-self-center">
				<h5 class="font-15 mb-0 ps-1 pt-1" style="color:green">R$ <?php echo $valorF ?></h5>
...
<div class="divider mt-2 mb-2"></div>
	...
	<a href="receber" class="btn btn-full btn-m gradient-highlight shadow-bg shadow-bg-s mt-3"  onclick="navigateToPage(event, 'receber')">Ver Todas</a>
</div>
