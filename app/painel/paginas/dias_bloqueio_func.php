...
<div class="page-content header-clear-medium">
  ...
  <div class="card card-style">
    <div class="content">
      <?php
     $query = $pdo->query("SELECT * FROM dias_bloqueio where funcionario = '$id_usuario' ORDER BY id asc");
          ...
          <div class="splide__list">
            <div class="splide__slide mx-3">
              <div class="d-flex">
                ...
                <div>
                <h5 class="mt-1 mb-0" style="font-size: 13px;"> {$dataF}</h5>    
                 <p class="font-10 mt-n2 mb-0"> {$nome_servico} </p> 
                </div>   
            ...
            <div class="splide__slide mx-3">
              ...
              <div class="d-flex">
                <div class="ms-auto">
                  ...
                  <a onclick="excluir_dias('{$id}', '{$nome_servico}')" href="#" class="icon icon-xs rounded-circle shadow-l bg-google"><i class="bi bi-trash-fill text-white"></i></a>           
...
<div class="offcanvas offcanvas-top rounded-m offcanvas-detached" style="height:98%" id="popupForm">
  <div class="content mb-4">
    ...
    <form id="form_dias_bloqueio" method="post" class="demo-animation needs-validation m-0">
  ...
  <div class="col-12 col-md-6">
    <div class="form-floating mb-3 position-relative">
      ...
      <input value="<?php echo $data_atual ?>" type="date" class="form-control rounded-xs ps-5" name="data">
