...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init_template(){
        ...
        if(!addOfflineClasses.length){
            ...
            offlineAlert.innerHTML = '<i class="bi bi-wifi-off pe-2"></i> Nenhuma Conexão de Internet Encontrada';
            onlineAlert.className = 'online-message bg-green-dark shadow-bg shadow-bg-s color-white';
            onlineAlert.innerHTML = '<i class="bi bi-wifi pe-2"></i> Você está online Novamente.';
