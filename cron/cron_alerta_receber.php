...
$query = $pdo->query("SELECT * from receber where data_venc = curDate() and pago != 'Sim' and (alerta is null or alerta != 'Sim') and pessoa > 0 and pessoa is not null and hora_alerta <= curTime() ");
