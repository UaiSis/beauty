(function() {
    ...
    // custom scrollbar - DESABILITADO para compatibilidade com navegadores modernos
    // O scroll nativo do navegador é mais performático e não gera erros de preventDefault
