...
<style>
	...
	.compras-header-content {
		flex: 1;
	}

	.compras-title-wrapper {
		display: flex;
		align-items: center;
		gap: 12px;
		margin-bottom: 8px;
	...
	.compra-card-mobile.pago {
		border-left-color: #00d896;
	}

	.compra-card-mobile.pendente {
		border-left-color: #ff9800;
	}

	.compra-card-mobile.vencido {
		border-left-color: #ef5350;
	}
	...
	.compra-card-detail-item {
		display: flex;
		flex-direction: column;
	}

	.compra-card-detail-label {
		font-size: 11px;
		color: #6c757d;
		margin-bottom: 4px;
		text-transform: uppercase;
	...
	.compra-card-action-btn.view {
		background: rgba(66, 165, 245, 0.1);
		color: #42a5f5;
	}

	.compra-card-action-btn.baixar {
		background: rgba(0, 216, 150, 0.1);
		color: #00d896;
	}

	.compra-card-action-btn.delete {
		background: rgba(239, 83, 80, 0.1);
		color: #ef5350;
	}

	.btn-nova-compra-mobile {
		background: #007A63;
		color: #fff;
		border: none;
		border-radius: 50%;
...
<div class="compras-page-modern">
	
	<div class="compras-header">
		<div class="compras-header-content">
			<div class="compras-title-wrapper">
				<div class="compras-title-icon">
					<i class="fa fa-truck"></i>
				</div>
				<h1 class="compras-title">Compras</h1>
			</div>
			<p class="compras-subtitle">Gerencie todas as compras e contas a pagar</p>
			<div class="compras-divider"></div>
		</div>
		<button onclick="inserir()" class="btn-nova-compra">
	...
	<button onclick="inserir()" class="btn-nova-compra-mobile">
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
					<div class="modal-title-main">
						...
						<span id="titulo_inserir">Nova Compra</span>
					</div>
					<div class="modal-subtitle">
						Registre uma nova compra de produto no sistema
					</div>
				</div>
			...
			<form id="form">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control sel2" id="produto" name="produto" style="width:100%;" required> 
									<?php 
					...
					<!-- Quantidade e Forma de Pagamento -->
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn-submit">
						...
						<span id="btn-text">Salvar Compra</span>
					</button>
				</div>
			</form>
		</div>
			...
			<div class="modal-body">
				...
				<div style="background: #fafbfc; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
					<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px;">
						...
						<span style="font-size: 14px; font-weight: 600; color: #1a1a1a;">Valor</span>
					</div>
				...
				<div style="background: #fafbfc; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
					<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px;">
						...
						<span style="font-size: 14px; font-weight: 600; color: #1a1a1a;">Fornecedor</span>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4" style="margin-bottom: 12px;">
							<div style="font-size: 12px; color: #6c757d; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Telefone</div>
							<div style="font-size: 14px; font-weight: 600; color: #1a1a1a;" id="telefone_dados"></div>
						</div>
						<div class="col-md-4" style="margin-bottom: 12px;">
							<div style="font-size: 12px; color: #6c757d; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Forma PGTO</div>
				...
				<div style="text-align: center; margin-top: 24px;">
					<div style="font-size: 12px; color: #6c757d; margin-bottom: 12px; text-transform: uppercase; letter-spacing: 0.5px;">Nota Fiscal</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
					...
					<div class="modal-subtitle">
						Confirme o pagamento da compra
					</div>
				</div>
...
<script type="text/javascript">
	...
	function inserir(){
		$('#mensagem').text('');
		$('#titulo_inserir').text('Nova Compra');
		$('#btn-text').text('Salvar Compra');
		limparCampos();
