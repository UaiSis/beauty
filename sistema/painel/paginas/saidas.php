...
<style>
	...
	.saidas-header-content {
		flex: 1;
	}

	.saidas-title-wrapper {
		display: flex;
		align-items: center;
		gap: 12px;
		margin-bottom: 8px;
	...
	.saida-card-detail-item {
		display: flex;
		flex-direction: column;
	}

	.saida-card-detail-label {
		font-size: 11px;
		color: #6c757d;
		margin-bottom: 4px;
		text-transform: uppercase;
...
<div class="saidas-page-modern">
	
	<div class="saidas-header">
		<div class="saidas-header-content">
			<div class="saidas-title-wrapper">
				<div class="saidas-title-icon">
					<i class="fa fa-sign-out"></i>
				</div>
				<h1 class="saidas-title">Saídas de Estoque</h1>
			</div>
			<p class="saidas-subtitle">Histórico completo de todas as saídas de produtos do estoque</p>
			<div class="saidas-divider"></div>
		</div>
	</div>
	...
	<div style="margin-bottom: 20px; display: flex; gap: 12px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
		<div style="display: flex; align-items: center; gap: 8px;">
			...
			<select id="itens_por_pagina" onchange="listarSaidas(0)" style="
				padding: 8px 12px;
				border: 2px solid #e9ecef;
				border-radius: 8px;
				font-size: 13px;
