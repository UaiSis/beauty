					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="instancia" name="instancia" placeholder="Instância AuthKey" place value="<?php echo @$instancia ?>">   
							</div> 
						</div>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<select class="form-control" name="entrada" id="pgto_api">
