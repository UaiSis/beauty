...
<style>
	/* Página de Contas a Receber Moderna */
	.receber-page-modern {
		padding: 24px;
		background: #f8f9fa;
		min-height: 100vh;
	...
	.receber-header-content {
		flex: 1;
	}

	.receber-title-wrapper {
		display: flex;
		align-items: center;
		gap: 12px;
		margin-bottom: 8px;
...
<div class="receber-page-modern">
	
	<div class="receber-header">
		<div class="receber-header-content">
			<div class="receber-title-wrapper">
				<div class="receber-title-icon">
					<i class="fa fa-dollar"></i>
				</div>
				<h1 class="receber-title">Contas a Receber</h1>
			</div>
			<p class="receber-subtitle">Gerencie todas as contas e receitas a receber</p>
			<div class="receber-divider"></div>
		</div>
			...
			<div class="modal-header">
				<div class="modal-title">
					...
					<div class="modal-subtitle">
						Registre uma nova conta a receber no sistema
					</div>
				</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-7">
							<div class="form-group">
								<label>Serviço</label>
								<select class="sel2" id="servico" name="servico" style="width:100%;">
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<select class="form-control" id="frequencia" name="frequencia" style="width:100%;"> 
									<?php 
									$query = $pdo->query("SELECT * FROM frequencias ORDER BY dias asc");
									$res = $query->fetchAll(PDO::FETCH_ASSOC);
									$total_reg = @count($res);
									if($total_reg > 0){
										for($i=0; $i < $total_reg; $i++){
			...
			<div class="modal-body">
				...
				<div style="background: #fafbfc; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
					...
					<div class="row">
						...
						<div class="col-md-4" style="margin-bottom: 12px;">
							<div style="font-size: 12px; color: #6c757d; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Recebimento</div>
				...
				<div style="background: #fafbfc; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
					<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px;">
						...
						<span style="font-size: 14px; font-weight: 600; color: #1a1a1a;">Cliente e Serviço</span>
					</div>

					<div class="row">
						<div class="col-md-12" style="margin-bottom: 12px;">
							<div style="font-size: 12px; color: #6c757d; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Cliente</div>
					...
					<div class="row">
						<div class="col-md-6" style="margin-bottom: 12px;">
							<div style="font-size: 12px; color: #6c757d; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Serviço</div>
							<div style="font-size: 14px; font-weight: 600; color: #1a1a1a;" id="servico_dados"></div>
						</div>
						<div class="col-md-6" style="margin-bottom: 12px;">
							<div style="font-size: 12px; color: #6c757d; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Frequência</div>
							<div style="font-size: 14px; font-weight: 600; color: #1a1a1a;"><span id="frequencia_dados"></span> Dias</div>
						</div>
					</div>
				</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
					...
					<div class="modal-subtitle">
						Confirme o recebimento da conta
					</div>
				</div>
