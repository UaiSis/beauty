...
// Converter para float e tratar valores vazios
$valor_serv = floatval($valor_serv);
$valor_serv_restante = floatval($valor_serv_restante);

if(empty($valor_serv) || $valor_serv == 0){
	echo 'Valor do serviço não informado!';
	exit();
}
...
$pdo->query("UPDATE receber SET valor = '0', pago = 'Sim', data_pgto = curDate(), usuario_baixa = '$usuario_logado', pgto = '$pgto', caixa = '$id_caixa', hora = curTime() where comanda = '$id'");
...
//lançar o restante
$pdo->query("INSERT INTO $tabela SET descricao = '$descricao', tipo = 'Comanda', valor = '$valor_serv_restante', data_lanc = curDate(), data_venc = '$data_pgto_restante', data_pgto = '$data_pgto2_restante', usuario_lanc = '$usuario_logado', usuario_baixa = '$usuario_baixa', foto = 'sem-foto.jpg', pessoa = '$cliente', pago = '$pago_restante', pgto = '$pgto_restante', func_comanda = '$usuario_logado', comanda = '$id', caixa = '$id_caixa', hora = curTime(), hora_alerta = '$hora_random'");	
}




$pdo->query("INSERT INTO $tabela SET descricao = '$descricao', tipo = 'Comanda', valor = '$valor_serv', data_lanc = curDate(), data_venc = '$data_pgto', data_pgto = '$data_pgto2', usuario_lanc = '$usuario_logado', usuario_baixa = '$usuario_baixa', foto = 'sem-foto.jpg', pessoa = '$cliente', pago = '$pago', pgto = '$pgto', func_comanda = '$usuario_logado', comanda = '$id', caixa = '$id_caixa', hora = curTime(), hora_alerta = '$hora_random'");

// Atualizar cartões de fidelidade
