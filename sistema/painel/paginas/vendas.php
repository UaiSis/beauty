...
<style>
	...
	.table-action-icon.comprovante {
		color: #9c27b0;
		background: rgba(156, 39, 176, 0.08);
	}

	.table-action-icon.comprovante:hover {
	...
	.venda-card-mobile.pago {
		border-left-color: #00d896;
	}

	.venda-card-mobile.pendente {
		border-left-color: #ff9800;
	}

	.venda-card-mobile.vencido {
		border-left-color: #ef5350;
	}
	...
	.venda-card-detail-item {
		display: flex;
		flex-direction: column;
	}

	.venda-card-detail-label {
		font-size: 11px;
		color: #6c757d;
		margin-bottom: 4px;
		text-transform: uppercase;
	...
	.venda-card-action-btn.view {
		background: rgba(66, 165, 245, 0.1);
		color: #42a5f5;
	}

	.venda-card-action-btn.baixar {
		background: rgba(0, 216, 150, 0.1);
		color: #00d896;
	}

	.venda-card-action-btn.delete {
		background: rgba(239, 83, 80, 0.1);
		color: #ef5350;
	}

	.btn-nova-venda-mobile {
		background: #007A63;
		color: #fff;
		border: none;
		border-radius: 50%;
...
<div class="vendas-page-modern">
	
	<div class="vendas-header">
		<div class="vendas-header-content">
			<div class="vendas-title-wrapper">
				<div class="vendas-title-icon">
					<i class="fa fa-shopping-cart"></i>
				</div>
				<h1 class="vendas-title">Vendas</h1>
			</div>
			<p class="vendas-subtitle">Gerencie todas as vendas e contas a receber</p>
			<div class="vendas-divider"></div>
		</div>
		<button onclick="inserir()" class="btn-nova-venda">
	...
	<div class="vendas-mobile-list">
		<div id="listar-mobile"></div>
	</div>

	<button onclick="inserir()" class="btn-nova-venda-mobile">
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
					<div class="modal-title-main">
						...
						<span id="titulo_inserir">Nova Venda</span>
					</div>
					<div class="modal-subtitle">
						Registre uma nova venda de produto no sistema
					</div>
				</div>
			...
			<form id="form">
				<div class="modal-body">
					...
					<!-- Produto, Cliente e Quantidade -->
					<div class="row">
						<div class="col-md-5">
							<div class="form-group">
								<label>Produto <span class="required">*</span></label>
								<select onchange="calcular()" class="form-control sel2" id="produto" name="produto" style="width:100%;" required> 
									<?php 
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input onchange="calcular()" type="number" class="form-control" id="quantidade" name="quantidade" placeholder="Qtd" value="1" required>    
							</div> 	
						</div>	
					</div>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn-submit">
						...
						<span id="btn-text">Salvar Venda</span>
					</button>
				</div>
			</form>
		</div>
...
<script type="text/javascript">
	...
	function inserir(){
		$('#mensagem').text('');
		$('#titulo_inserir').text('Nova Venda');
		$('#btn-text').text('Salvar Venda');
		limparCampos();
